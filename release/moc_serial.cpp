...
QT_MOC_LITERAL(1, 7, 15), // "commandComplete"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "next"
QT_MOC_LITERAL(4, 29, 4) // "back"

    },
    "Serial\0commandComplete\0\0next\0back"
};
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->commandComplete(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::commandComplete)) {
                *result = 0;
                return;
            }
        }
